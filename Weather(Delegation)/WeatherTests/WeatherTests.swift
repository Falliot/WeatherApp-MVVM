...
class WeatherTests: XCTestCase {
  ...
  func testWeatherViewModel() {
    ...
    XCTAssertEqual(Utility.dayFromDate(currentDate: weather.date), weatherViewModel.day)
    XCTAssertEqual(weather.maxtempC, weatherViewModel.maxTemp)
    XCTAssertEqual(weather.mintempC, weatherViewModel.minTemp)
    XCTAssertEqual(weather.hourly.first?.weatherIconUrl.first?.value, weatherViewModel.iconURL)
  }
}
